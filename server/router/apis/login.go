...
// @Success      200      {object} wrench.BaseResponse "成功响应，返回JWT令牌(code:0)"
// @Failure      400      {object} wrench.BaseResponse "参数错误(code:40000)"
// @Failure      401      {object} wrench.BaseResponse "密码错误(code:40102)"
// @Failure      404      {object} wrench.BaseResponse "记录不存在(code:40001)"
// @Failure		 500      {object} wrench.BaseResponse "服务器内部错误(code:50000)"
...
func Login(context *gin.Context) {
	...
	context.JSON(http.StatusOK, wrench.SuccessWithData(token))
	return
}
